# LinkedIn post — draft 3 (Mantle-specific)
...
That's the difference between a demo and an agent you can ship. And it matters even more for voice: in chat, a wrong answer is a screenshot; on a call, it's a customer hearing your agent improvise. Mantle runs the same agent for voice and chat — tests like these are how a voice experience earns the right to pick up the phone.
